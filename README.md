...
> 사주 데이터를 오늘의 운세, 전공 탐색, 학업 조언과 팀 역할 추천으로 연결한 대학생 대상 개인화 웹 서비스

<p align="center">
  <img src="README_images/09-home-today.png" width="360" alt="FourPillars 오늘의 운세 메인 화면" />
</p>
...
| 구분 | 내용 |
| --- | --- |
| 문제 | 기존 사주 서비스는 해석 결과를 보여 주는 데 그쳐 대학생의 전공 탐색, 학업과 팀 활동에 바로 활용하기 어렵습니다. |
| 해결 | 하나의 사주 계산 결과를 오늘의 운세, 학과 추천, 학업 조언과 팀플 역할 추천으로 변환해 실제 대학 생활의 선택과 행동으로 연결했습니다. |
| 차별점 | 외부 사주 계산 API에 의존하지 않고 원국·절입·십성·신살·용신·대운을 직접 계산하며, 결과의 근거를 점수·그래프·설명으로 함께 제공합니다. |
