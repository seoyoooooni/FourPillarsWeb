  ...
  return <section className="auth-panel signup-onboarding" aria-label="회원가입 및 프로필 설정">
    ...
    <form className="signup-step-form" onSubmit={next} noValidate>
      <div className="signup-step-content">
        ...
        {step === "birthTime" && <StepInput title="태어난 시간을 선택해 주세요" hint="한국 표준시 기준으로 계산해요. 태어난 지역의 시차나 서머타임은 반영되지 않아요." error={error}><div className="signup-picker"><BirthTimeField value={birthTime} onChange={value => { setBirthTime(value); setError(""); }} /></div></StepInput>}
